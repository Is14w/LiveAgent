export const ZH_CN_COMMON_TRANSLATIONS = {
  ...
  "trajectory.metric.failovers": "切换",
  "trajectory.metric.transport": "传输",
  "trajectory.transport.systemProxy": "系统代理",
  "trajectory.transport.direct": "直连",
  ...
  "chat.runtime.planMode": "计划",
  "chat.upload.addSection": "添加",
  "chat.upload.files": "文件",
  "chat.upload.folder": "文件夹",
  "chat.upload.selectFolder": "选择一个文件夹并将其挂载为项目目录",
  ...
  "chat.runtime.reasoningCompact.off": "关闭",
  "chat.runtime.reasoningCompact.minimal": "最低",
  "chat.runtime.reasoningCompact.low": "低",
  "chat.runtime.reasoningCompact.medium": "中",
  "chat.runtime.reasoningCompact.high": "高",
  "chat.runtime.reasoningCompact.xhigh": "极高",
  "chat.runtime.reasoningCompact.max": "最高",
  ...
  "chat.toolApproval.sidebarStatus": "等待批准",
  "chat.toolApproval.approveAll": "全部允许",
  "chat.toolApproval.denyAll": "全部拒绝",
  "chat.toolApproval.body": "是否允许执行此 {tool} 操作？",
  "chat.toolApproval.terminal": "终端",
  "chat.toolApproval.approve": "允许本次",
  "chat.toolApproval.approveSession": "本会话始终允许 {tool}",
  "chat.toolApproval.moreActions": "更多审批选项",
  ...
  "workspaceSshTerminal.openedInWorkbench": "该会话已在画板中打开",
  "workspaceSshTerminal.focusWorkbenchPane": "前往 Pane",
  ...
  "mcpHub.authClientIdPlaceholder": "留空则自动动态注册",
  "mcpHub.oauthConnect": "连接",
  "mcpHub.oauthReauthorize": "重新授权",
  "mcpHub.oauthDisconnect": "断开授权",
  ...
  "workbench.terminalConnecting": "正在启动终端…",
  "workbench.terminalError": "终端连接失败",
  "workbench.terminalExited": "终端进程已退出",
